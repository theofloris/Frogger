...
int menu(WINDOW *win){
    ...
    keypad(stdscr, true);    // keyboard input
...
// function to color the welcome menu
...
// function to color the main menu
...
// function to color the credits menu
...
// function to reset the game or quit 
...
// function to print the restart menu 
...
// function to color the restart menu line
